...
//!
//! This crate is Apache-2.0 (the rest of engrams is AGPL-3.0) so that a
//! custom harness built on `engram-harness-sdk` links no AGPL code.
//! Keep it dependency-light and free of platform logic; `engram-core`
//! re-exports everything here as `engram_core::types::ids`.
