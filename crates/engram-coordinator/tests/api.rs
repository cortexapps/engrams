...
//!
//! NOTE (ADR 0039 Task 32): tests for the web-facing session, exec, events,
//! snapshot, and lifecycle routes were removed from this file. Those routes
//! no longer exist on the coordinator; equivalent coverage lives in the
//! orchestrator layer and its test suite.
