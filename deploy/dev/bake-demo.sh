...
echo "  (the enable materializes on a host — the host-agent needs the flake's"
echo "   tar-capable mke2fs on PATH (ADR 0082): launch tilt from 'nix develop'."
echo "   Homebrew's mke2fs is built WITHOUT libarchive and cannot pack.)"
