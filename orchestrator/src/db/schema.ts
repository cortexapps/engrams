...
export const taskSession = pgTable(
  "task_session",
  {
    ...
    // ADR 0107: immutable connection/operation/resource authority used to
...
/** ADR 0107: one named-connection grant. The connection fixes the provider
...
export const profile = pgTable(
  "profile",
  {
    ...
    // ADR 0107: structured integration authority. Unlike the retired flat
...
/** ADR 0107: a named credential instance. Google Cloud config is non-secret;
...
/** KEK-sealed private keys for the tenant OIDC issuer (ADR 0107). */
