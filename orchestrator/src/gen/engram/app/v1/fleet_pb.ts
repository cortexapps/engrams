...
export type GetStorageSummaryResponse = Message<"engram.app.v1.GetStorageSummaryResponse"> & {
  ...
  /**
   * False when `gc_pending` is the stats system's live-tuple estimate:
   * past 100k rows an exact count is a full scan (30s at 22.7M rows).
   *
   * @generated from field: bool gc_pending_exact = 9;
   */
  gcPendingExact: boolean;
};
