...
import { makeGoogleTokenBrokerRoute } from "./routes/google-token-broker.ts";
...
// ADR 0107: public OIDC metadata for customer WIF providers. No session or
...
app.route("/", makeGoogleTokenBrokerRoute());
