...
export const file_engram_app_v1_task: GenFile = /*@__PURE__*/
  fileDesc("", [file_engram_app_v1_session, file_engram_app_v1_profile, file_engram_app_v1_user]);
...
export type CreateTaskRequest = Message<"engram.app.v1.CreateTaskRequest"> & {
   ...
   *
   * @generated from field: bool defer_initial_prompt = 10;
   */
   ...
   *
   * @generated from field: optional string model_router = 11;
   */
  modelRouter?: string;
};
...
export type Task = Message<"engram.app.v1.Task"> & {
  ...
  /**
   * @generated from field: optional string parent_task_id = 14;
   */
  parentTaskId?: string;

  /**
   * @generated from field: optional string root_task_id = 15;
   */
  rootTaskId?: string;

  /**
   * @generated from field: optional string local_task_name = 16;
   */
  localTaskName?: string;

  /**
   * @generated from field: optional string canonical_task_name = 17;
   */
  canonicalTaskName?: string;

  /**
   * @generated from field: optional string spawning_session_id = 18;
   */
  spawningSessionId?: string;

  /**
   * @generated from field: repeated engram.app.v1.Task descendants = 19;
   */
  descendants: Task[];
