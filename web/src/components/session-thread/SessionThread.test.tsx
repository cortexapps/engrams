    ...
    renderWithProviders(
      <SessionThread
        ...
        events={indexed([
          ...
          { type: 'agent_message', run_id: 'r1', message_id: 'a1', role: 'assistant', text: 'on it', at: AT },
  ...
  test('an opened PR renders the harness-register card', async () => {
    renderWithProviders(
      <SessionThread
        ...
        events={indexed([
          {
            type: 'pull_request_opened', url: 'https://gh/x/pull/7', repo: 'x/y', title: 'Fix the flaky test',
